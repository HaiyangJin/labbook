...
## 下载安装
  ...
  [官方下载网址](https://www.zotero.org/)
  
  可以直接参考下方链接网址里的安装教程进行安装配置。
  
  [zotero安装教程](https://blog.csdn.net/qq_47885795/article/details/141631652?spm=1001.2014.3001.5506)
...
**1.Jasminum 茉莉花（必装，后面在Word中文献引用时非常实用，但有时年份可能会有点错误，注意一下）**
